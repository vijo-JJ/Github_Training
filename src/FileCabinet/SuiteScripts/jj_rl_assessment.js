 ...
 *
 * Description : Create an invoice record in NetSuite through an external system integration.
 * 
 * 
 * 
 * 
    ...
    (record) => {
        ...
        const post = (requestBody) => {
            ...
            try{
                ...
                invoiceData.setValue({
                    fieldId:'location',
                    value:requestBody.loactionid
                });
                invoiceData.selectNewLine({
                    sublistId:'item'
                });
                invoiceData.setCurrentSublistValue({
                    sublistId:'item',
                    fieldId:'item',
                    value:requestBody.itemid
                });
                invoiceData.commitLine({
                    sublistId:'item'
                });

                let invoiceId=invoiceData.save();
                log.debug({
                    title:"success",
